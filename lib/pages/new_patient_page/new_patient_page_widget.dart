...
class NewPatientPageWidget extends StatefulWidget {
  const NewPatientPageWidget({super.key});

  @override
  State<NewPatientPageWidget> createState() => _NewPatientPageWidgetState();
}

class _NewPatientPageWidgetState extends State<NewPatientPageWidget> {
  late NewPatientPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewPatientPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.dateText = dateTimeFormat(
          'd/M/y',
          getCurrentTimestamp,
                    ...
                    children: [
                            ...
                            Text(
                              ...
                              style: FlutterFlowTheme.of(context)
                                  ...
                                  .override(
                                    ...
                                    useGoogleFonts:
                                        GoogleFonts.asMap().containsKey('Hebo'),
                                  ),
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'xt4w7uyb' /* Chronic Medical Illnesses */,
                            ),
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController7!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController8!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController9!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController10!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController11!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController12!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController13!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController14!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController15!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              '3klgm8oa' /* Impression and Diagnosis */,
                            ),
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            ...
                            suffixIcon: _model.textController16!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _model.textController17!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                      ...
                      Builder(
                        builder: (context) {
                          final localListOfUplodedPathes =
                              _model.listOfUploadedPaths.toList();
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: localListOfUplodedPathes.length,
                            itemBuilder:
                                (context, localListOfUplodedPathesIndex) {
                              final localListOfUplodedPathesItem =
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            var photosRecordReference =
                                PhotosRecord.collection.doc();
                            await photosRecordReference
                                .set(createPhotosRecordData(
                              image: '  dsdsd',
                            ));
                            _model.actionLink =
                                PhotosRecord.getDocumentFromData(
                                    createPhotosRecordData(
                                      image: '  dsdsd',
                                    ),
                                    photosRecordReference);
                            setState(() {
                              _model.addToListOfUploadedPaths(
                                  _model.actionLink!.image);
                            });
